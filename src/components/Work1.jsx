...
export default function Work1() {
    ...
    return (
        <div ref={container} className="w-full h-full flex justify-center border-8 bg-black items-center">
           ...
           <div onClick={() => {
              ...
              className="w-2/3 h-1/3 relative md:h-2/3 md:w-1/3 group">
                ...
                <p className="z-10 transition-opacity duration-300 top-0 flex justify-center items-center absolute inset-0 opacity-0 group-hover:opacity-100 md:text-3xl text-white">Graduation</p>
